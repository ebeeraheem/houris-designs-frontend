      ...
      <main className="relative isolate overflow-hidden px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        ...
        <div className="page-shell">
          <PageReveal>
            ...
            <div data-page-intro className="mt-6 mb-10 max-w-[42rem]">
            ...
            <div
              data-page-section
              className="grid gap-8 lg:grid-cols-2 lg:gap-x-12"
            >
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="pr-4 pb-3 text-[0.68rem] font-medium tracking-[0.18em] text-foreground/60 uppercase">
                          Code
                        </th>
                        <th className="pr-4 pb-3 text-[0.68rem] font-medium tracking-[0.18em] text-foreground/60 uppercase">
                          Full Length
                        </th>
                        <th className="pb-3 text-[0.68rem] font-medium tracking-[0.18em] text-foreground/60 uppercase">
                          Full Sleeve
                        </th>
                      </tr>
                    </thead>
              ...
              <div className="surface-card p-6 sm:p-8">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="pr-3 pb-3 text-[0.68rem] font-medium tracking-[0.18em] text-foreground/60 uppercase">
                          Code
                        </th>
                        <th className="pr-3 pb-3 text-[0.68rem] font-medium tracking-[0.18em] text-foreground/60 uppercase">
                          Bust
